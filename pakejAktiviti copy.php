                                ...
                                <div class="room-1-block wow fadeInUp" data-wow-delay="<?php echo htmlspecialchars($animation_delay); ?>s" data-wow-duration=".8s">
                                    ...
                                    <div class="room-1-content">
                                        ...
                                        <h4 class="room-1-title mb_20">
                                            <a href="aktivitiDetail copy.php?id_aktiviti=<?php echo htmlspecialchars($aktiviti->getId()); ?>"><?php echo strtoupper(htmlspecialchars($aktiviti->getNamaAktiviti())); ?></a>
                                        </h4>
                                        <p class="room-1-text mb_30"><?php echo htmlspecialchars($aktiviti->getPenerangan()); ?></p>
                                        <div class="link-btn">
                                            <a href="aktivitiDetail copy.php?id_aktiviti=<?php echo htmlspecialchars($aktiviti->getId()); ?>" class="btn-1 btn-alt">Lihat Butiran <span></span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
