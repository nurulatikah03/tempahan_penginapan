        ...
        <div class="container-md mt-5" style="max-width: 800px;">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="assets/PDF/PDF_room.php?viewInvoice" target="_blank" class="btn" style="background-color: white; border :solid; border-radius :50px; ">View invoice<span></span></a>
                </div>
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-sm-4">
