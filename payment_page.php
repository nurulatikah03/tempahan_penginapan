            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-8">
                            <?php echo $_POST["num_of_night"]?> Hari
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-8">
                            RM<?php echo $_POST["price"]?>
                        </div>
                    </div>
                </div>
                <div class="card-footer text-end">
                    <a href="#" class="btn btn-primary">Proceed to Payment</a>
                    <a href="#" class="btn btn-secondary">Edit Booking</a>
                </div>
            </div>
        </div>
        <!-- Booking Summary END -->
