            ...
            <div class="row">                
                <div class="col-lg-8 pe-lg-35">
                    <div class="single-post">                        
                        <span class="section_heading_title_small">RM99.00 setiap seorang</span>
                        <h2 class="mb_40">Pakej Teambuilding</h2>
                        <p class="mb_20">Pakej teambuilding direka untuk meningkatkan kerjasama dan 
										komunikasi dalam kalangan ahli pasukan. Aktiviti yang akan 
										dijalankan dapat membantu peserta membina kepercayaan Selain 
										itu, sesi latihan dalam kumpulan dan perbincangan santai 
										memberi ruang untuk ahli mengenali antara satu sama lain dalam 
										suasana yang lebih santai dan tidak formal.</p>
										
                        <p class="mb_40">Kebaikan pakej teambuilding termasuk peningkatan moral pekerja 
										dan pengembangan kemahiran sosial yang penting. Dengan melibatkan 
										semua ahli pasukan dalam aktiviti yang menyeronokkan dan mendidik, 
										organisasi dapat merangsang semangat dan motivasi, serta membina 
										hubungan yang lebih kuat. Ini bukan sahaja menjadikan tempat kerja 
										lebih harmoni, tetapi juga meningkatkan produktiviti keseluruhan pasukan.</p>
										
                        <div class="mb_60"><img src="assets/images/resource/teambuilding.jpg" alt=""></div>
                        <h3 class="fs_40 mb_30">Kemudahan</h3>
                        <p class="mb_50">Kemudahan yang disediakan semasa teambuilding dijalankan biasanya dirancang untuk 
                        ...
                        <div class="row mb_30">
                            ...
                            <div class="col-md-6 col-sm-6 mb_45">
                                <div class="d-flex align-items-center">
                                    ...
                                    <p class="fw_medium mb_0">Makan minum  (6x/hari)</p>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6 mb_45">
                                <div class="d-flex align-items-center">
                                    <i class="fas fa-moon icon theme-color fs_40 w_55 mr_25"></i>
                                    <p class="fw_medium mb_0">(Hari 1 –  minum petang, makan malam dan minum malam)</p>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6 mb_45">
                                <div class="d-flex align-items-center">
                                    <i class="fas fa-utensils icon theme-color fs_40 w_55 mr_25"></i>
                                    <p class="fw_medium mb_0">(Hari 2 – Sarapan pagi, minum pagi, makan tengahari, minum petang, makan malam dan minum malam</p>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6 mb_45">
                                <div class="d-flex align-items-center">
                                    <i class="fas fa-sun icon theme-color fs_40 w_55 mr_25"></i>
                                    <p class="fw_medium mb_0">(Hari 3 – Sarapan pagi, minum pagi dan makan tengahari)</p>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6 mb_45">
                                <div class="d-flex align-items-center">
