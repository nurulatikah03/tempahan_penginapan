						...
						<div class="card-body">
							...
							<div class="row mb-3" style="height: 400px;">
								...
								<div class="col-8">
									...
									<div class="row" style="height: 200px;">
										<?php for ($i = 0; $i < 3; $i++): ?>
											<div class="col-3 pt-2 img-content-text">
										...
										<?php if (count($imgList) > 3): ?>
											<div class="col-3 pt-2 more-images" style="position: relative;">
												<img src="../<?php echo $imgList[3]; ?>" alt="View More Image" class="img-fluid" style="border-radius:25px; height: 190px; width: 100%; object-fit: cover;">
							...
							<div class=" text-center">
								<a href="#" data-bs-toggle="modal" data-bs-target="#uploadModal-3">
									<button type="button" class="btn btn-primary rounded-button">Kemaskini Gambar</button>
								</a>
							</div>
							<br>
							<hr>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="preview-container">
							<img src="../<?php echo $room->getImgMain(); ?>" class="preview-image" id="mainImage" style="border-radius: 25px;">
						</div>

						<form id="upload-form-1" action="controller/updateImgMain.php" method="post" enctype="multipart/form-data">
							<div class="text-center">
								<div id="drop-area-1" class="drop-area">Tarik atau Tekan gambar baru</div>
								<input type="file" id="fileElem-1" accept="image/*" style="display:none" name="file">
							</div>
			...
			<div class="modal-dialog modal-lg-custom">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="preview-container">
							<img src="../<?php echo $room->getImgBanner(); ?>" class="preview-image" style="border-radius: 25px;">
						</div>
						...
						<form id="upload-form-2" action="controller/updateImgMain.php" method="post" enctype="multipart/form-data">
							<div class="text-center">
			...
			<div class="modal-dialog modal-lg-custom">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<form id="upload-form-3" action="test2.php" method="post" enctype="multipart/form-data">
							<div class="text-center">
								<label for="fileElem-3">
									<div id="drop-area-3" class="drop-area">Tarik atau Tekan gambar baru</div>
									<input type="file" id="fileElem-3" name="file" accept="image/png, image/jpeg, image/jpg, image.webp" style="display:none" multiple>
								</label>
							</div>
							<div id="new-image-message-3" style="display: none; text-align: center; margin-top: 20px;">
								<h3>Gambar baru</h3>
							</div>
